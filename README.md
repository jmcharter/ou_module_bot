...
1. Fetches the complete list of OU modules from the official API
...
.
├── src/ou_bot/
│   ├── common/          # Shared utilities (database, config, models)
│   ├── reddit_bot/      # Bot implementation and templates
│   │   ├── submission_bot.py
│   │   ├── comment_bot.py
│   │   └── templates/   # Mako response templates
│   └── module_scraper/  # Module scraper implementation
├── infrastructure/      # Docker and deployment files
├── data/               # SQLite database and Mako cache
├── tests/              # Test suite
...
- **mako**: Template engine for responses
